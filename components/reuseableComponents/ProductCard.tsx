...
const ProductCard: React.FC<CardProps> = ({ image, heading, price, id }) => {
  return (
    ...
    >
      ...
      {/* Add to Cart button */}
      <button className="w-[162px] md:w-[304px] rounded relative bottom-[7.68rem] md:bottom-[9rem] left-1/2 transform -translate-x-1/2 px-4 md:px-8  py-2 md:py-4 bg-black/70 text-white opacity-0 group-hover:opacity-100 transition-opacity">
